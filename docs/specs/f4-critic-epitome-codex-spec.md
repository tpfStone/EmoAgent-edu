...
| **IP 解释**（是否传达"理解了处境"） | 误解、答非所问，或用无依据动机推断替代理解 | 复述表面事实，或只有低信息量换词安抚 | 有文本依据地准确点出对方未明说的情绪/担忧（体现"听懂了"），不替学生或第三方下动机、人格、因果结论 |
...
- IP 解释：回应是否传达"理解了对方的处境和感受"。0=误解、答非所问，或用无依据动机推断替代理解；1=只复述表面，或只有低信息量换词安抚；2=有文本依据地准确点出对方没明说的情绪或担忧，不替学生或第三方下动机、人格、因果结论。
