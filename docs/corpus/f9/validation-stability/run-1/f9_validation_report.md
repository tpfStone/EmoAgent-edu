...
- 重跑样本 ER=2 为 35/40，IP=2 为 36/40，仍接近满分饱和。
...
- ER/IP_all_2: True
- F4_distribution: {'ER': {'2': 20}, 'IP': {'2': 20}, 'EX': {'1': 3, '2': 9, '0': 8}}
...
- blind_annotation_path: `docs\corpus\f9\validation-stability\run-1\rerun\f9_rerun_blind_annotation.csv`
- f4_holdout_path: `docs\corpus\f9\validation-stability\run-1\rerun\f9_rerun_f4_scores_holdout.csv`
- rerun_scores_path: `docs\corpus\f9\validation-stability\run-1\rerun\f9_rerun_selected_scores.csv`
- low_score_review_queue_path: `docs\corpus\f9\validation-stability\run-1\rerun\f9_low_score_review_queue.csv`
- low_score_review_queue_rows: 3
- f3_detected_flags_in_selected_rows: 0
- generator_fallback_rows: 0
- ER/IP_all_2: False
- F4_distribution: {'ER': {'1': 5, '2': 35}, 'IP': {'2': 36, '1': 4}, 'EX': {'2': 13, '0': 17, '1': 10}}

## Generated Global Quality Flagged Rows

| sample_no | candidate_id | flags |
|---:|---|---|
| 27 | c2 | global_contains:说明你 |

## Rerun Global Quality Flagged Rows

| sample_no | candidate_id | flags |
|---:|---|---|
| 19 | c2 | global_contains:说明你 |
| 31 | c2 | global_contains:说明你 |
| 37 | c2 | global_contains:说明你 |
