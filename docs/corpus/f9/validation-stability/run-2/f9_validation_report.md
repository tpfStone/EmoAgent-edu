...
- 重跑样本 ER=2 为 36/40，IP=2 为 36/40，仍接近满分饱和。
...
- ER/IP_all_2: False
- F4_distribution: {'ER': {'2': 19, '1': 1}, 'IP': {'2': 19, '1': 1}, 'EX': {'0': 8, '2': 9, '1': 3}}
...
- blind_annotation_path: `docs\corpus\f9\validation-stability\run-2\rerun\f9_rerun_blind_annotation.csv`
- f4_holdout_path: `docs\corpus\f9\validation-stability\run-2\rerun\f9_rerun_f4_scores_holdout.csv`
- rerun_scores_path: `docs\corpus\f9\validation-stability\run-2\rerun\f9_rerun_selected_scores.csv`
- low_score_review_queue_path: `docs\corpus\f9\validation-stability\run-2\rerun\f9_low_score_review_queue.csv`
- low_score_review_queue_rows: 0
- f3_detected_flags_in_selected_rows: 0
- generator_fallback_rows: 0
- ER/IP_all_2: False
- F4_distribution: {'ER': {'2': 36, '1': 4}, 'IP': {'2': 36, '1': 4}, 'EX': {'2': 14, '0': 18, '1': 8}}

## Generated Global Quality Flagged Rows

| sample_no | candidate_id | flags |
|---:|---|---|
| 11 | c1 | global_contains:说明你 |

## Rerun Global Quality Flagged Rows

| sample_no | candidate_id | flags |
|---:|---|---|
| 17 | c1 | global_contains:说明你 |
