...
- rerun_ER_2: 36/40 (上限: <= 32/40)
- rerun_IP_2: 37/40 (上限: <= 32/40)
...
- 重跑样本 ER=2 为 36/40，IP=2 为 37/40，仍接近满分饱和。
...
- blind_annotation_path: `docs\corpus\f9\validation-stability\post-erip-run-2\rerun\f9_rerun_blind_annotation.csv`
- f4_holdout_path: `docs\corpus\f9\validation-stability\post-erip-run-2\rerun\f9_rerun_f4_scores_holdout.csv`
- rerun_scores_path: `docs\corpus\f9\validation-stability\post-erip-run-2\rerun\f9_rerun_selected_scores.csv`
- low_score_review_queue_path: `docs\corpus\f9\validation-stability\post-erip-run-2\rerun\f9_low_score_review_queue.csv`
- low_score_review_queue_rows: 0
- f3_detected_flags_in_selected_rows: 0
- generator_fallback_rows: 0
- ER/IP_all_2: False
- F4_distribution: {'ER': {'2': 36, '1': 4}, 'IP': {'2': 37, '1': 3}, 'EX': {'2': 18, '1': 20, '0': 2}}

## Rerun Global Quality Flagged Rows

| sample_no | candidate_id | flags |
|---:|---|---|
| 12 | c1 | global_contains:挺难得 |
